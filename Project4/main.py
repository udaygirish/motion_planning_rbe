...
if __name__ == "__main__":
    ...
    planner.visualize(make_video=False) #, video_name="path_kinematic_test.mp4", show=True)
    t3 = time.time()

    print("Time taken to plan: ", round(t2-t1,3))
    print("Time taken to visualize: ", round(t3-t2,3))
    print("Total time: ", round(t3-t1,3))
