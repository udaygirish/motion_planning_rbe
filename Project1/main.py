...
from intersections import all_pairs_intersections, efficient_intersections, all_pairs_intersections_mod
...
def main():
    ...
    for N in range(0, 500, 10):
        ...
        start = time.time()
        points1 = all_pairs_intersections_mod(L1, L1)
        # Use all_pairs_intersections_mod to get the correct result as the default one is allowing duplicates
        # in case of same list as we are matching the same lines two times. the {}_mod one is custom added by me
